  ...
  return (
    <section className="grid items-start grid-cols-1 gap-12 text-center md:grid-cols-2">
      ...
      <div className="p-8 space-y-4 border shadow-xl border-neos/30 bg-strong rounded-3xl">
        <h2 className="text-2xl font-black tracking-wider text-gray-300 uppercase">Ubicación</h2>
      ...
      <div className="flex flex-col justify-center h-full p-8 space-y-4 border shadow-xl border-neos/30 bg-strong rounded-3xl">
        <h2 className="text-2xl font-black tracking-wider text-gray-300 uppercase">Comunidad</h2>
        <p className="text-xs text-gray-500">Seguinos para rutinas, lanzamientos y stock alerts.</p>
        <div className="flex justify-center gap-4 pt-2">
          {redes?.map((red) => (
            <a
              ...
              className="flex items-center justify-center w-12 h-12 p-3 text-gray-300 transition-all duration-300 border rounded-full shadow-md border-neos/30 bg-fondo hover:text-neos hover:border-neos/30 hover:-translate-y-1"
          ...
          {equipo?.map((persona, index) => (
            ...
            >
              <img
                ...
                onError={(e) => { e.target.src = "https://images.unsplash.com/photo-1534438327276-14e5300c3a48?q=80&w=150"; }}
              />
              <div className="text-left">
                <p className="font-bold tracking-wide text-gray-100 text-m">{persona.nombre}</p>
